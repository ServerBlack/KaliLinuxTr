 ...
 */
public class UyeOl extends Fragment {
//burasi üye ol kısmıdır.
String url="http://kali-linuxtr.net/login/login";
    public UyeOl() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_uye_ol, container, false);

        WebViewClient wvc = new WebViewClient();
        WebView webview = (WebView) view.findViewById(R.id.webUyeOl);
